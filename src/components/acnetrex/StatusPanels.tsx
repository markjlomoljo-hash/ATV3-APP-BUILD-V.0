...
const labels: Record<ModuleReadiness, string> = {
  ...
  memory_not_configured: "Memory not configured",
  ml_unavailable: "ML unavailable",
  cloud_run_unavailable: "Cloud Run unavailable",
  vertex_unavailable: "Vertex AI unavailable",
  evidence_unavailable: "Evidence unavailable",
  report_worker_not_configured: "Report worker not configured",
  native_device_required: "Native device required",
...
const classes: Record<ModuleReadiness, string> = {
  ...
  memory_not_configured: "border-slate-200 bg-slate-100 text-slate-700",
  ml_unavailable: "border-rose-200 bg-rose-50 text-rose-800",
  cloud_run_unavailable: "border-rose-200 bg-rose-50 text-rose-800",
  vertex_unavailable: "border-rose-200 bg-rose-50 text-rose-800",
  evidence_unavailable: "border-amber-200 bg-amber-50 text-amber-900",
  report_worker_not_configured: "border-slate-200 bg-slate-100 text-slate-700",
  native_device_required: "border-sky-200 bg-sky-50 text-sky-800",
