...
- Branch: `feat/phase7-profile-reports`; current evidence commit: `92c57bc`.
- GitHub Actions push and pull-request CI runs for `92c57bc` both completed successfully.
